...
urlpatterns = [
    ...
    path(
        "projects/<int:pk>/submit-application/", views.submit_application, name="submit_application"
    ),
    path(
    ...
    path(
        "moderation/<int:pk>/decide/", views.moderate_project_decide, name="moderate_project_decide"
    ),
    # Profile
